        ...
        foreach ($arrUtype as $key => $Utypevalue){
            if(($Utypevalue == "admin")){
                ...
                if(($Utypevalue == "ContentManager")){
                    ...
                    $PcontentManager1 ="manaloto";
                    $ContentManager2 = "juan";
                    $PcontentManager2 = "delacruz";
                    
        
                    if(($_POST['Username'] == $ContentManager1 && $_POST['Password']==$PcontentManager1))
                    {
                    ...
                    elseif(($_POST['Username'] == $ContentManager2 && $_POST['Password']==$PcontentManager2)){
                            $_SESSION['Username'] = $ContentManager2;
                            echo '<div class="alert alert-success w-50 p-3 mx-auto">
                            welcome to the system ',$ContentManager2,
                           '<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> </div>'; 
                        }
                        else
                        {
                    ...
                    if(($Utypevalue == "SystemUS")){
                        ...
                        if(($_POST['Username'] == $SystemUS1 && $_POST['Password']==$PSystemU1))
                        {
